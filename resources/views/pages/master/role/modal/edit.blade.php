    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 my-7">
                <form id="form-edit" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                      @submit.prevent="update(editVal.id)">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-select-solid departments-select2" name="department_id"
                                        id="selectedDepartment" data-dropdown-parent="#modal-edit">
                                        ...
                                        <div class="form-check mb-4">
                                            <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       name="permission[]"
                                                       multiple
                                                       :checked="editVal.permissions?.hasOwnProperty(permission.id)"
                                                >
