...
@section('content')
    <div x-data="productData()">
        @include('pages.master.product.modal.create')
        @include('pages.master.product.modal.edit')
    ...
    <script>
        function productData() {
            return {
                ...
                async searchData() {
                    try {
                        const response = await axios.get('/master/product/search', {
                ...
                async save() {
                    ...
                    try {
                        await axios.post(`/master/product`, new FormData(this.formCreate))
                ...
                async edit(id) {
                    const resp = await axios.get(`/master/product/show/${id}`);
                    this.editVal = resp.data;
                },
                async update(id) {
                    this.buttonLoading = true;
                    try {
                        await axios.post(`/master/product/update/${id}`, new FormData(this.formEdit))
                ...
                async destroy() {
                    showConfirmModal("Anda yakin?", "Data akan hilang.", "Ya, Hapus!", async () => {
                        try {
                            await axios.post(`/master/product/destroy`, new FormData(this.deleteForm));
                ...
                async productData() {
                    const products = await axios.get('/master/product/data');
