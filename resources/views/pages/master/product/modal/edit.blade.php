                ...
                <form id="form-edit" @submit.prevent="update(editVal.id)">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="name" name="name" class="form-control form-control-solid"
                               placeholder="Nama Produk" :value="editVal.name"/>
                    </div>

                    <div class="mb-10">
                        <label for="name" class="required form-label">Kategori</label>
                        <input type="text" id="category" name="category" class="form-control form-control-solid"
                               placeholder="Kategori" x-bind:value="editVal.category"/>
                    </div>

                    <div class="mb-10">
                        <label for="name" class="required form-label">Harga Satuan</label>
                        <input type="number" id="unit_price" name="unit_price" class="form-control form-control-solid"
                               placeholder="Kategori" x-bind:value="editVal.unit_price"/>
                    </div>
                    <div class="float-end">
