            ...
            <div class="modal-body">
                <form id="form-create" @submit.prevent="save()">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="code" name="code" class="form-control form-control-solid" placeholder="Kode"/>
                    </div>


                    <div class="mb-10">
                        <label for="name" class="required form-label">Nama</label>
                        <input type="text" id="name" name="name" class="form-control form-control-solid" placeholder="Nama Produk"/>
                    </div>

                    <div class="mb-10">
                        <label for="name" class="required form-label">Kategori</label>
                        <input type="text" id="category" name="category" class="form-control form-control-solid" placeholder="Kategori"/>
                    </div>

                    <div class="mb-10">
                        <label for="name" class="required form-label">Harga Satuan</label>
                        <input type="number" id="unit_price" name="unit_price" class="form-control form-control-solid" placeholder="Kategori"/>
                    </div>
                    <div class="float-end">
