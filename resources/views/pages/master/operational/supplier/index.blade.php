        ...
        function supplierData() {
            return {
                ...
                async getSupplierData() {
                    try {
                        const suppliers = await axios.get('/master/operational/suppliers/data');
                ...
                async saveSupplier(id = null) {
                    ...
                    try {
                        if (!id) {
                            ...
                            await axios.post(`/master/operational/suppliers/${id}`, new FormData(this.form))
                                .then(async () => {
                                    await this.successResponse();
                                })
                        }
                ...
                async edit(id) {
                    const resp = await axios.get(`/master/operational/suppliers/${id}`);
                ...
                async destroy() {
                    showConfirmModal("Anda yakin?", "Data akan hilang.", "Ya, Hapus!", async () => {
                        try {
                            await axios.post(`/master/operational/suppliers/destroy`, new FormData(this.formDelete));
                ...
                async successResponse() {
                    ...
                    this.form.reset();
                    this.modalForm.hide();
                    const resp = await axios.get(`${this.suppliers.path}?page=${this.suppliers.current_page}`);
                    this.suppliers = resp.data
                }
            }
        }
