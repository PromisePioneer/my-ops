    ...
    function broadbandPacketData() {
        return {
            ...
            async getBroadbandPacketData() {
                this.isLoading = true;
                try {
                    const resp = await axios.get('/master/common/broadband-packets/data');
            ...
            async searchData() {
                this.isLoading = true;
                try {
                    const resp = await axios.get('/master/common/broadband-packets/search', {
                        params: {
                            search: this.search
                        },
            ...
            async save(id = null) {
                ...
                try {
                    if (!id) {
                        await axios.post('/master/common/broadband-packets', new FormData(this.form))
                    } else {
                        await axios.post(`/master/common/broadband-packets/${id}`, new FormData(this.form))
                    }
            ...
            async edit(id) {
                const resp = await axios.get(`/master/common/broadband-packets/${id}`);
            ...
            async destroy() {
                showConfirmModal("Anda yakin?", "Data akan hilang.", "Ya, Hapus!", async () => {
                    try {
                        await axios.post(`/master/common/broadband-packets/destroy`, new FormData(this.deleteForm));
