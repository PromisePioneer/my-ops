    ...
    <script defer>
        function contactData() {
            return {
                ...
                async searchData() {
                    try {
                        const resp = await axios.get('/common-master-data/contact/search', {
                ...
                async edit(id) {
                    const resp = await axios.get(`/common-master-data/contact/edit/${id}`);
                    this.editVal = resp.data;
                },
                async destroy() {
                    showConfirmModal("Anda yakin?", "Data akan hilang.", "Ya, Hapus!", async () => {
                        try {
                            await axios.post(`/common-master-data/contact/destroy`, new FormData(this.formDelete));
                ...
                async contactData() {
                    this.isLoading = true;
                    try {
                        const resp = await axios.get('/common-master-data/contact/data')
                        this.contacts = resp.data
                    } catch (e) {
                        console.log(e)
                    } finally {
