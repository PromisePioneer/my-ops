                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <select name="type" id="type" class="form-select form-select-solid"
                                        x-model="contactType">
                                    <option value="Client" :selected="editVal?.type ==='Client'">
                                        Klien
                                    </option>
                                    <option value="Supplier" :selected="editVal?.type ==='Supplier'">
                                        Supplier
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6" x-show="contactType === 'Supplier'" x-transition x-cloak>
                            <div class="mb-4">
