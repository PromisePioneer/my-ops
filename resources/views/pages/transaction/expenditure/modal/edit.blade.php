                ...
                <div class="modal-body">
                    <div class="mb-10">
                        ...
                        <input type="text" id="description" name="description" class="form-control form-control-solid"
                               placeholder="Deskripsi" :value="editVal.description"/>
                    </div>
                    <div class="mb-10">
                        <label for="name" class="required form-label">Akun Debit</label>
                        <select name="debit_account_id" id="selectedDebitAccount"
                    ...
                    <div class="mb-10">
                        ...
                        <select name="credit_account_id" id="selectedCreditAccount"
