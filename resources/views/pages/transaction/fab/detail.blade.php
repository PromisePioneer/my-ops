        ...
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
            <div class="card border-top-0">
                ...
                <div class="card-body">
                                    ...
                                    @foreach($serviceCategories as $service)
                                        <div class="col-md-5 mt-2">
                                            <input class="form-check-input" type="checkbox"
                                                   value="{{ $service->id }}" {{ in_array($service->id, $test) ? 'checked' : '' }} @readonly(true)/>
                    ...
                    <div class="row ms-1">
                        <p class="fw-bolder">Data Perusahaan :</p>
                    </div>
                    ...
                    <div class="row ms-1 fw-bolder">
                        Tata Cara Pembayaran
                    </div>
                    <div class="row ms-1 fw-bold ms-4">
                        <p>Pembayaran dapat dilakukan paling lambat pada tanggal 30 setiap bulannya, dengan cara
                            transfer
                            ke rekening di :</p>
                        <table class="ms-2 table-bordered w-400px">
                            <tr>
                            ...
                            <tr>
                                <td>Atas Nama</td>
                                <td>:</td>
                                <td class="">PT MAYATAMA SOLUSINDO</td>
                            </tr>
                        </table>
