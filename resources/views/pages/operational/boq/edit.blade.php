                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-5">
                                    <input type="text" class="form-control form-control-solid required" name="title"
                                           id="title"
                                           placeholder="Judul BoQ" value="{{ $boq->title }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group row mb-6">
                                    ...
                                    <div class="col-lg-11 fv-row">
                                        <input type="date" class="form-control form-control-solid fw-bolder pe-5 date"
                                               placeholder="Tanggal" name="date" id="date" value="{{ $boq->date }}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                        ...
                                        <td class="ps-0" style='text-align:center; vertical-align:middle'>
                                            <textarea :name="`data[${index}][description]`"
                                                      ...
                                                      data-kt-autosize="true" x-model="field.description"></textarea>
                                        </td>
                                    ...
                                    <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                        ...
                                        <td class="ps-0" style='text-align:center; vertical-align:middle'>
                                            <select :name="`projectTimeline[${index}][unit_type_id]`"
                                                    class="form-select form-select-solid unit-type-select2"
                                                    :id="`selectedUnitTypeProjectTimeline-${index}`">
                                                <option></option>
                                            </select>
                                        </td>
                                        <td class="ps-0" style='text-align:center; vertical-align:middle'>
    ...
    <script>
        function generateBoQ() {
            return {
                ...
                async init() {
                    await this.getBoqCommodity();
                    await this.getProjectTimeline();
                    this.$nextTick(async () => {
                ...
                async getBoqCommodity() {
                    const resp = await axios.get(`/inventory/boq/get-boq-commodity/${this.id}`);
                    this.boqCommodities = resp.data;

                    this.boqCommodities.forEach((field, index) => {
                        this.$nextTick(() => {
                            const selectedUnitType = $(`#selectedUnitTypeProjectTimeline-${index}`);
                            $.ajax({
                                type: 'GET',
                                dataType: "JSON",
                                url: `/inventory/boq/unit-type/selected/${field.unit_type_id}`,
                ...
                async generateBoQ() {
                    ...
                    try {
                        await axios.post(`/inventory/boq/${this.id}`, new FormData(this.form))
