                ...
                <div class="py-5">
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 table-striped" id="kt_table_users">
                            ...
                            <template x-if="!isLoading && odpAreasData.data?.length === 0">
                                <tbody class="fw-bold">
                                <tr>
                                    <td colspan="9">
                            ...
                            <template x-for="area in odpAreasData?.data" :key="area.id">
                                <tbody class="fw-bold">
                                <tr>
                                    <td>
                    ...
                    <ul class="pagination float-end mb-4 mt-4">
                        <template x-for="pagination in odpAreasData.links">
        ...
        function odpArea() {
            return {
                ...
                async save() {
                    ...
                    try {
                        await axios.post('/master/odp-areas', new FormData(this.formCreate))
                ...
                async update(id) {
                    this.buttonLoading = true;
                    try {
                        await axios.post(`/master/odp-areas/update/${id}`, new FormData(this.formEdit))
                        await showAlert('success', 'Data berhasil disimpan')
                        this.formEdit.reset();
                        this.modalEdit.hide();
                        await this.init();
                ...
                async destroy() {
                    showConfirmModal("Anda yakin?", "Data akan hilang.", "Ya, Hapus!", async () => {
                        try {
                            await axios.post(`/master/odp-areas/destroy`, new FormData(this.formDelete));
