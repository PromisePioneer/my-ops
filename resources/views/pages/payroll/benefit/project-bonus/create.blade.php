...
@section('page-title', 'Tambah Bonus Project')
@section('content')
            ...
            <div class="card p-10">
                <form id="form" @submit.prevent="save()">
                    <div class="card-body p-12">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-5">
                                    <input type="text" class="form-control form-control-solid"
                                           placeholder="Nama Pelanggan" name="customer_name" id="customer_name">
                                </div>
                            </div>
                        </div>
                                ...
                                <template x-for="(field,index) in fields" :key="index">
                                    <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                        <td class="pe-7" style='text-align:center; vertical-align:middle'>
                                            <select x-model="field.user_id" :name="`data[${index}][user_id]`"
                        ...
                        <div class="mb-10">
                            <label class="form-label fs-6 fw-bolder text-gray-700">Deskripsi Pekerjaan</label>
        ...
        function generateProjectBonus() {
            return {
                ...
                async save() {
                    ...
                    try {
                        await axios.post(`/payroll/setting/benefit/project-bonus/`, new FormData(this.form))
