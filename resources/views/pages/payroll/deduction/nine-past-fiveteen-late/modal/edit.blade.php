            ...
            <form id="form-edit" @submit.prevent="update(editVal.id)">
                <div class="modal-body">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="technician_id" id="selectedUser"
                    ...
                    <div class="mb-10">
                        <label for="name" class="required form-label">Total Terlambat</label>
                        <input type="number" id="total_amount_of_late" name="total_amount_of_late"
                               class="form-control form-control-solid"
                               placeholder="Total Terlambat" :value="editVal.total_amount_of_late"/>
                    </div>
                </div>
