                ...
                <div class="py-5">
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 table-striped" id="kt_table_users">
                            ...
                            <template x-if="!isLoading && overtimeAllowances.data?.length === 0">
                                <tbody class="fw-bold">
                                <tr>
                                    <td colspan="9">
                            ...
                            <template x-for="overtimeAllowance in overtimeAllowances?.data"
                                      :key="overtimeAllowance.id">
                                <tbody class="fw-bold">
                                <tr>
                                    <td>
                                        <div class="form-check form-check-sm form-check-custom form-check-solid"
                                            ...
                                            <input class="form-check-input" type="checkbox"
                                                   :value="overtimeAllowance.id"
                                                   :id="'checkbox-' + overtimeAllowance.id"/>
                                        </div>
                                    </td>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <ul class="pagination float-end mb-4 mt-4">
                            <template x-for="pagination in overtimeAllowances.links">
...
@push('script')
    <script>
        ...
        function overtimeAllowanceData() {
            return {
                overtimeAllowances: [],
                isLoading: false,
                buttonLoading: false,
                ...
                async searchData() {
                    ...
                    try {
                        ...
                        this.overtimeAllowances = response.data;
                    } catch (error) {
