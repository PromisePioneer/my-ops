...
@section('content')
    <div x-data="branchesData()">
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            @include('pages.general-master-data.branches.modal.create')
            @include('pages.general-master-data.branches.modal.edit')
            @include('pages.general-master-data.branches.modal.create-children')
            @include('pages.general-master-data.branches.modal.children-detail')
    ...
    <script defer>
        function branchesData() {
            return {
                ...
                async edit(id) {
                    const resp = await axios.get(`/general-master-data/branch/show/${id}`);
