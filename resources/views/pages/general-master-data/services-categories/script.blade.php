    ...
    function servicesCategoriesData() {
        return {
            ...
            async getServiceCategories() {
                this.isLoading = true;
                try {
                    const resp = await axios.get('/general-master-data/service-categories/data');
            ...
            async saveServiceCategory(id = null) {
                ...
                try {
                    if (!id) {
                        await axios.post('/general-master-data/service-categories/', new FormData(this.form))
                    } else {
                        await axios.post(`/general-master-data/service-categories/update/${id}`, new FormData(this.form))
                    }
