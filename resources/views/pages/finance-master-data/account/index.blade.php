...
@section('content')
    <div x-data="accountData()">
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            @include('pages.finance-master-data.account.modal.edit')
        ...
        function accountData() {
            return {
                ...
                async searchData() {
                    this.isLoading = true;
                    try {
                        const response = await axios.get('/finances-master-data/account/search', {
                ...
                async save() {
                    ...
                    try {
                        await axios.post('/finances-master-data/account', new FormData(this.formCreate))
                ...
                async saveChild(id) {
                    this.buttonLoading = true;
                    try {
                        await axios.post(`/finances-master-data/account/create-child/${id}`,
                ...
                async edit(id) {
                    console.log(id)
                    const resp = await axios.get(`/finances-master-data/account/edit/${id}`);
                    this.editVal = resp.data;
                },
                async update(id) {
                    this.buttonLoading = true;
                    try {
                        await axios.post(`/finances-master-data/account/update/${id}`,
                ...
                async destroy() {
                    showConfirmModal("Anda yakin?", "Data akan hilang.", "Ya, Hapus!", async () => {
                        try {
                            await axios.post(`/finances-master-data/account/destroy`, new FormData(this.deleteForm));
                ...
                async importData() {
                    this.buttonLoading = true;
                    try {
                        await axios.post('/finances-master-data/account/import/', new FormData(this.formImport))
                        await showAlert('success', 'Data berhasil disimpan');
                ...
                async getAccountData() {
                    this.isLoading = true;
                    try {
                        const accounts = await axios.get('/finances-master-data/account/data');
