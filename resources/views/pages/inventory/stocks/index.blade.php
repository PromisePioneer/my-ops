        ...
        function itemStockData() {
            return {
                ...
                async getMustReorderStock() {
                    this.isLoading = true;
                    try {
                        const resp = await axios.get('/inventory/stocks/must-reorder');
                ...
                async getGoodsStock() {
                    this.isLoading = true;
                    try {
                        const resp = await axios.get('/inventory/stocks/data');
                ...
                async getMainBranchesWithStock(id) {
                    ...
                    $(".main-branches-select2").select2({
                        ...
                        placeholder: "Pilih Cabang",
                        ajax: {
                            url: `/inventory/stocks/branch/data/${id}`,
                            dataType: "JSON",
                            type: "GET",
                            data: params => ({search: params.term}),
                            processResults: data => ({results: data}),
                ...
                async searchData() {
                    this.isLoading = true;
                    try {
                        const resp = await axios.get('/inventory/stocks/search', {
                ...
                async filter() {
                    this.isLoading = true;
                    try {
                        const resp = await axios.get('/inventory/stocks/filter', {
                            params: {
                ...
                async showStockDetail(id) {
                    ...
                    const resp = await axios.get(`/inventory/stocks/show/${id}`);
