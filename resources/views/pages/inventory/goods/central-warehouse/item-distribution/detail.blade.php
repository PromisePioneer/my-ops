...
@section('content')
    <div x-data="centralWarehouseItemDetailData()">
        @include('pages.inventory.goods.central-warehouse.modal.create-sn')
        @include('pages.inventory.goods.central-warehouse.modal.edit-item')
        <div class="row">
            <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                            <table class="table w-100">
                                ...
                                <tr class="fw-bold ">
                                    ...
                                    <th class="w-10px">:</th>
                                    <th x-text="formatDate(centralWarehouseItem?.item_transaction.date)"></th>
                                </tr>
                                <tr class="fw-bold">
                                    <th>Nama Barang</th>
                                    <th>:</th>
                                    <th x-text="centralWarehouseItem?.item_transaction.item?.name"></th>
                                </tr>
                                <tr class="fw-bold">
                                    <th>Total yang Belum Diberi SN</th>
                                    <th>:</th>
                                    <th x-text="`${centralWarehouseItem.central_warehouse_item?.qty} ${centralWarehouseItem?.item_transaction.item?.unit_type.name}`"></th>
                                </tr>
                                <tr class="fw-bold">
                                    <th>Total yang Sudah Diberi SN</th>
                                    <th>:</th>
                                    <th x-text="`${centralWarehouseItem.central_warehouse_stock} ${centralWarehouseItem?.item_transaction.item?.unit_type.name}`"></th>
                                </tr>
                                <tr class="fw-bold">
                                    <th>Lokasi Gudang</th>
                                    <th>:</th>
                                    <th x-text="centralWarehouseItem?.item_transaction.warehouse.name"></th>
                                </tr>
                                </thead>
                                <tbody class="fw-bold">
                                <tr>
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end " data-kt-user-table-toolbar="base">
                        <div class="d-flex justify-content-end " data-kt-user-table-toolbar="base">
                            <template
                                    x-if="centralWarehouseItem?.central_warehouse_item.item?.need_sn === 0 && centralWarehouseItem?.central_warehouse_item.qty !== 0 && centralWarehouseItem?.item_transaction.from_po === 1">
                            ...
                            <template
                                    x-if="centralWarehouseItem?.central_warehouse_item.item?.need_sn === 1 && centralWarehouseItem?.central_warehouse_item.qty !== 0 && centralWarehouseItem?.item_transaction?.from_po === 1">
                                <button type="button" class="btn btn-light-primary btn-sm"
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 text-center">
                                ...
                                <template x-if="centralWarehouseItem?.central_warehouse_item.item?.need_sn === 1">
                            ...
                            <template x-for="stock in centralWarehouseStocks?.data"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <template
                                                x-if="centralWarehouseItem?.central_warehouse_item?.item.need_sn === 1 && stock.status === 0">
    ...
    <script>
        function centralWarehouseItemDetailData() {
            return {
                ...
                centralWarehouseItemId: "{{ $centralWarehouseItem->id }}",
                ...
                async getCentralWarehouseStock() {
                    const resp = await axios.get(`/inventory/list-of-items/central-warehouse-stocks/data/${this.itemTransactionId}`);
                    this.centralWarehouseStocks = resp.data;
                },
                async getCentralWarehouseItem() {
                    this.isLoading = true;
                    try {
                        const resp = await axios.get(`/inventory/list-of-items/item-transactions/po-data/detail/data/${this.itemTransactionId}`);
                ...
                async searchData() {
                    try {
                        const resp = await axios.get(`/inventory/list-of-items/central-warehouse-stocks/search/${this.itemTransactionId}`, {
                ...
                async generateCodeAndSN() {
                    ...
                    try {
                        await axios.post(`/inventory/list-of-items/central-warehouse-stocks/generate-sn/${this.centralWarehouseItemId}`, new FormData(this.formCreateSN))
