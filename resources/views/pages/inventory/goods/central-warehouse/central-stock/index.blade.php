<div x-data="centralStockData()">
    @include('pages.inventory.goods.central-warehouse.central-stock.modal.stock-detail')
                    ...
                    <template x-for="(item, index) in itemStock?.data" :key="item.id">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a :href="`/inventory/list-of-items/central-warehouse-stocks/send-item/${item.id}`"
