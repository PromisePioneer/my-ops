            ...
            <div class="card-body">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="item-distribution" role="tabpanel">
                        @include('pages.inventory.list-of-items.central-warehouse-items.item-distribution.index')
                    </div>

                    <div class="tab-pane fade" id="stock-data" role="tabpanel">
                        @include('pages.inventory.list-of-items.central-warehouse-items.central-stock.index')
                    </div>
                </div>
            </div>
        </div>
