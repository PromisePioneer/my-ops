<div class="modal fade" tabindex="-1" id="modal-branch-role-work-time">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="form-branch-role-work-time" @submit.prevent="save()">
                        ...
                        <div class="col-md-6">
                            <div class="mb-10">
                                ...
                                <x-select2.index name="role_id"
                                                 ...
                                                 parentElementIfExist="#modal-branch-role-work-time"
                                />
                            </div>
                        </div>
                        <div class="col-md-6">
