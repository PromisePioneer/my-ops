...
var KTLayoutAside = function () {
    ...
    return {
        init: function () {
            var i, r;
            (t = document.querySelector("#kt_aside"), e = document.querySelector("#kt_aside_toggle"), (n = document.querySelector("#kt_aside_menu_wrapper")) && (i = n.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(i, n) && n.scroll({
                top: KTUtil.getRelativeTopPosition(i, n),
                behavior: "smooth"
            }), t && e) && ((r = KTToggle.getInstance(e)).on("kt.toggle.change", (function () {
                ...
                KTCookie.set("aside_minimize_state", r.isEnabled() ? "on" : "off", {expires: e})
            })))
        }
    }
}();
