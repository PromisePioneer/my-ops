...
class AttendanceSummaryController extends Controller
{
    ...
    {
        // Ambil dan group data absensi berdasarkan employee_id dan tanggal
        $attendances = $this->attendanceSummaryDetailForOneMonthBasedOnUserId($month, $year, $employeeId,
            $this->perPage);

        // Ambil data untuk total kehadiran dan total keterlambatan dalam satu bulan
        ...
        $summaryData = $totalPresentAndTotalMinutesLate->map(function ($items) {
            ...
            // Group by setiap hari untuk menghitung keterlambatan harian
