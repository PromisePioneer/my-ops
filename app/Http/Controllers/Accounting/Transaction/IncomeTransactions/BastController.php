...
use App\Http\Requests\Transaction\IncomeTransactions\Bast\BastRequest;
use App\Models\BAA;
use App\Models\Bast;
...
use App\Support\IncomeTransaction\BastService;
...
#[AllowDynamicProperties] class BastController extends Controller
{
    ...
    {
        return view('pages.transaction.income-transactions.bast.index');
    }
    ...
    {
        return view('pages.transaction.income-transactions.bast.create');
    }
    ...
    {
        return view('pages.transaction.income-transactions.bast.edit', compact('bast'));
    }
    ...
    public function detail(Bast $bast): View
    {
        ...
        return view('pages.transaction.income-transactions.bast.detail', compact('bast', 'getPoItem', 'totalPPN', 'total', 'companyProfile'));
    }
    ...
    {
        return view('pages.transaction.income-transactions.bast.view-file', compact('bast'));
    }
    ...
    public function exportToPDF(Bast $bast): Response
    {
        ...
        $total = $getPoItem->sum('price') + $totalPPN;
        $companyProfile = CompanyProfile::first();
        $view = view('pages.transaction.income-transactions.bast.export-pdf', compact('bast', 'getPoItem', 'totalPPN', 'total', 'companyProfile', 'getSPKName'))->render();
