...
use App\Support\PurchaseOrderService;
...
#[AllowDynamicProperties] class PurchaseOrderController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('pages.transaction.income-transactions.purchase-orders.index');
    }
    ...
    {
        $this->authorize('create', PurchaseOrder::class);
        return view('pages.transaction.income-transactions.purchase-orders.create');
    }
    ...
    {
        $this->authorize('update', PurchaseOrder::class);
        return view('pages.transaction.income-transactions.purchase-orders.edit', compact('purchaseOrder'));
    }
    ...
    public function detail(PurchaseOrder $purchaseOrder): View
    {
        ...
        return view('pages.transaction.income-transactions.purchase-orders.detail', compact('purchaseOrder', 'purchaseOrderItem', 'poCompany', 'total', 'totalPPN'));
    }
    ...
    public function exportToPDF(PurchaseOrder $purchaseOrder): Response
    {
        ...
        $view = view('pages.transaction.income-transactions.purchase-orders.export-pdf', compact(
