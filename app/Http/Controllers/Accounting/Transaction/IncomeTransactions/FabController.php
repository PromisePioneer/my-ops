...
use App\Http\Requests\Transaction\IncomeTransactions\Fab\FabRequest;
...
#[AllowDynamicProperties] class FabController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('pages.transaction.income-transactions.fab.index');
    }
    ...
    public function create(): View
    {
        ...
        return view('pages.transaction.income-transactions.fab.create');
    }
    ...
    public function detail(Fab $fab): View
    {
        ...
        return view('pages.transaction.income-transactions.fab.detail', compact('fabCompanyName', 'companyProfile', 'fabHasServiceCategories', 'fab', 'serviceCategories', 'test', 'total', 'totalPPN', 'fabHasSKL'));
    }

    public function viewFile(Fab $fab): View
    {
        return view('pages.transaction.income-transactions.fab.view-file', compact('fab'));
    }
    ...
    public function edit(Fab $fab): View
    {
        ...
        return view('pages.transaction.income-transactions.fab.edit', compact('fab'));
    }
    ...
    public function exportPDF(Fab $fab): Response
    {
        ...
        $view = view('pages.transaction.income-transactions.fab.export-pdf',
    ...
    public function contractPDF(Fab $fab): Response
    {
        ...
        $view = view('pages.transaction.income-transactions.fab.contract.index', compact('fab', 'serviceCategories', 'fabServiceCategories'));
        $pdf = Browsershot::html($view)
            ->setChromePath('/usr/bin/chromium')
            ->noSandbox()
            ->waitUntilNetworkIdle()
